...
instance SAUSAGE_GRD_M(C_Item)
{
	name = "Średnia zbroja strażnika";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
...
instance SAUSAGE_VLK_H(C_Item)
{
	name = "Ciężkie spodnie kopacza";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
...
instance SAUSAGE_SLD_M(C_Item)
{
	name = "Średnia zbroja najemnika";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 70;
	protection[PROT_BLUNT] = 70;
...
instance SAUSAGE_ORG_M(C_Item)
{
	name = "Średni strój szkodnika";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 30;
	protection[PROT_BLUNT] = 30;
...
instance SAUSAGE_ORG_H(C_Item)
{
	name = "Ciężki pancerz szkodnika";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 30;
	protection[PROT_BLUNT] = 30;
...
instance SAUSAGE_TPL_L(C_Item)
{
	name = "Lekka zbroja strażnika świątynnego";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 40;
	protection[PROT_BLUNT] = 40;
...
instance SAUSAGE_TPL_M(C_Item)
{
	name = "Średnia zbroja strażnika świątynnego";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 70;
	protection[PROT_BLUNT] = 70;
...
instance SAUSAGE_TPL_H(C_Item)
{
	name = "Ciężka zbroja strażnika świątynnego";
	mainflag = ITEM_KAT_ARMOR;
	flags = 0;
	protection[PROT_EDGE] = 70;
	protection[PROT_BLUNT] = 70;
...
instance SAUSAGE_GRI_M(C_Item)
{
	...
	material = MAT_METAL;
	description = name;
	text[0] = "Zbroja strażnika królewskiego";
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Point;
	count[2] = protection[PROT_POINT];
